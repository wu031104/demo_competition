...
# 读取数据
list1 = []
res = cursor.execute("select time from app01_lianghui_search")
...
# 读取数据
list2 = []
res = cursor.execute("select href from app01_lianghui_search")
for i in cursor.fetchall():
    for j in i:
        list2.append(j)
print(list2)
...
# 读取数据
list3 = []
res = cursor.execute("select author from app01_lianghui_search")
for i in cursor.fetchall():
    for j in i:
        list3.append(j)
print(list3)
...
# 读取数据
list5 = []
res = cursor.execute("select share_num from app01_lianghui_search")
for i in cursor.fetchall():
    for j in i:
        list5.append(j)
print(list5)
...
# 读取数据
list6 = []
res = cursor.execute("select pingllun_num from app01_lianghui_search")
for i in cursor.fetchall():
    for j in i:
        list6.append(j)
print(list6)
...
# 读取数据
list7 = []
res = cursor.execute("select dianzan_num from app01_lianghui_search")
for i in cursor.fetchall():
    for j in i:
        list7.append(j)
print(list7)
...
sql = 'insert into app01_feel_analyse_result(jiji,zhongxing,xiaoji,num,key_s, time, href, author, content, share_num, pingllun_num, dianzan_num) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
# # 读取数据
